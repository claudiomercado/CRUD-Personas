...
public class PersonaController extends BaseApiResponse {
	...
	public Persona createPersona(@RequestParam String nombre, @RequestParam String apellido, @RequestParam Integer edad,
			@RequestParam String dni) {
		return service.createPersona(service.createEntityPersona(nombre, apellido, edad, dni));
	}

	@PatchMapping("/updatePersona")
	public Persona updatePersona(@RequestParam(name = "id") Long id, @RequestParam String nombre,
			@RequestParam String apellido, @RequestParam Integer edad, @RequestParam String dni) {
...
//Metodos que redireccionan a las diferentes vistas 
	...
	public ModelAndView templateCreate(@RequestParam String nombre, @RequestParam String apellido,
			@RequestParam Integer edad, @RequestParam String dni) {
